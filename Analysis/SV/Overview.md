...
for i in $(seq 1 22);
do
    svtk vcf2bed --no-header WGSDP_Releasable_4.1_202405/annotated_by_pop.vcfs/gnomAD_SV_v3.release_4_1.WGSDP.sampleID_pcr_status.chr"${i}".annotated.GD_Evi_fixed.sites.gz test"${i}".bed
done
