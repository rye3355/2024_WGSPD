...
# Save 
mt.cols().select('sample_qc1').flatten().export(output='gs://2024-wgspd/qc/20240903_subset_sample_qc1.tsv')
...
# Save 
mt.cols().select('hq_sample_qc1').flatten().export(output='gs://2024-wgspd/qc/20240903_subset_hq_sample_qc1.tsv')
