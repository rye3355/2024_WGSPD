...
mt = mt.annotate_rows(
    ...
    AC= hl.min(mt["generate_counts_variant_qc"].AC) <= 5,
)

mt = mt.filter_rows(mt.AC & mt.syn & mt.gnomad_AC, keep = True)
...
mt2.repartition(10000).write("gs://2024-wgspd/snv/coding/outputs/202409028_WCPG/20240928_WGSPD_synonymous-MAC5-gnomadAC10", overwrite = True)
