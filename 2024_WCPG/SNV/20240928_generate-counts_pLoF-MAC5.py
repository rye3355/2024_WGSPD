...
mt = mt.filter_rows(mt.AC & mt.ptv, keep = True)
...
mt2.repartition(10000).write("gs://2024-wgspd/snv/coding/outputs/202409028_WCPG/20240928_WGSPD_pLoF-MAC5", overwrite = True)
