...
write.table(df, "/Users/rye/Projects/2024_WGSPD/2024_WCPG/plotting/inputs/SNV/20240929_ptv-ac5_old-analysis_Fisher.tsv",
            sep = "\t", col.names = T, row.names = F, quote = F)
write.table(df_rr, "/Users/rye/Projects/2024_WGSPD/2024_WCPG/plotting/inputs/SNV/20240929_ptv-ac5_old-analysis_rate-ratio.tsv",
            sep = "\t", col.names = T, row.names = F, quote = F)
